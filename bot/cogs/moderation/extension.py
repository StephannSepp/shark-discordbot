...
class Moderation(commands.Cog):
    ...
    async def warning_add(
        self, inter: CmdInter, user: User, reason: str="沒有提供理由", copy: TextChannel=None
    ):
        ...
        warning_id = module.add_warning(user.id, inter.guild_id, inter.author.id, reason)
    ...
    async def warning_remove(
        self, inter: CmdInter, user: User, warning_id: commands.LargeInt, copy: TextChannel=None
    ):
    ...
    @commands.guild_only()
    async def mute(
        self, inter: CmdInter, user: User, raw_duration: str, reason: str="沒有提供理由",
        copy: TextChannel=None, attachment: Attachment=None
    ):
    ...
    @commands.guild_only()
    async def kick(
        self, inter: CmdInter, user: User, reason: str = "沒有提供理由",
        copy: TextChannel=None, attachment: Attachment=None
    ):
